...
function textAnimate() {
    var clutter = "";
    document.querySelector("#overlay h1").textContent.split("")
        .forEach(function (char) {
            clutter += `<span>${char}</span>`;
        })

    document.querySelector("#overlay h1").innerHTML = clutter;
...
function textAnimate2() {
    var clutter = "";
    document.querySelector("#overlay h5").textContent.split("")
        .forEach(function (char) {
            clutter += `<span>${char}</span>`;
        })

    document.querySelector("#overlay h5").innerHTML = clutter;
...
function textAnimate3() {
    var clutter = "";
    document.querySelector("#overlay #second").textContent.split("")
        .forEach(function (char) {
            clutter += `<span>${char}</span>`;
        })

    document.querySelector("#overlay #second").innerHTML = clutter;
    ...
    gsap.to("#overlay #second span", {
        opacity: 0,
        scrollTrigger: {
            scrub: .8,
            trigger: "#overlay #second",
            start: "bottom 0%",
        },
        stagger: .2,
        ease: Power3.easeInOut
...
function Page2Animate() {
    ...
    var clutter = "";
    document.querySelector("#ak>h2").textContent.split(" ")
        .forEach(function (cha) {
            clutter += `<span>${cha}</span>`;
        })

    document.querySelector("#ak>h2").innerHTML = clutter;

    gsap.from("#page-2-ani span", {
        opacity: 0,
        scrollTrigger: {
            trigger: "#page2",
            scrub: .8,
...
function Page2Animate2() {
    ...
    var clutter = "";
    document.querySelector("#ak2>h2").textContent.split(" ")
        .forEach(function (cha) {
            clutter += `<span>${cha}</span>`;
        })

    document.querySelector("#ak2>h2").innerHTML = clutter;

    gsap.from("#page-2-second-ani span", {
        opacity: 0,
        scrollTrigger: {
            trigger: "#page2",
            scrub: .9,
...
function Navigation(){
    var menu = document.querySelector("#nav-close");
...
menu.addEventListener("click", () => {
    if (flag == 0) {
        ...
        line2.style.transform = `rotate(49deg)`;
...
var clutter = "";
document.querySelector("#page5 h1").textContent.split(" ")
    .forEach(function (cham) {
        clutter += `<span>${cham}</span>`;
    })
